...
# Functions for creating pbpm records
...
def aOut(name, DRVL=None, DRVH=None, **fields):
    return add_PINI(GenericDevice.ao(name + '_S', address=name,
        OMSL = 'supervisory', 
        DRVL = DRVL,  DRVH = DRVH,
#        EGUL = DRVL,  EGUF = DRVH,
        **fields))
...
def boolOut(name, ZNAM=None, ONAM=None, **fields):
    return add_PINI(GenericDevice.bo(name + '_S', address=name,
        OMSL = 'supervisory', 
...
def longOut(name, DRVL=None, DRVH=None, **fields):
    return add_PINI(GenericDevice.longout(name + '_S', address=name,
        OMSL = 'supervisory',
...
def mbbOut(name, *option_values, **fields):
    process_mbb_values(fields, option_values)
    return add_PINI(GenericDevice.mbbo(name + '_S', address=name,
...
def stringOut(name, **fields):
    return add_PINI(GenericDevice.stringin(name + '_S', **fields))
