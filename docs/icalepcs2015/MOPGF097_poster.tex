...
\begin{columns}
    \column{0.5}
    \block{TMBF Overview}{
        \begin{center} \includegraphics[scale=4.25]{figure1.pdf}\end{center}
    ...
    \block{Libera System Platform}{
        \begin{center} \includegraphics[scale=3]{figure2.pdf}\end{center}
...
\block{FPGA System Design And Data Paths}{
    \begin{tabular}{c m{5cm}}
        ...
        \includegraphics[scale=2.75]{figure5.pdf}
        \end{minipage}
    &
...
\block{Data Processing Chain}{
    \includegraphics[scale=3]{figure3.pdf}
    \includegraphics[scale=3]{figure4.pdf}
    \break
    \begin{multicols}{2}
...
\column{0.5}
    \block{Tune PLL}{
    \includegraphics[scale=3]{figure6.pdf}
    \parbox[b]{12.5cm} {
...
\column{0.5}
    \block{Detector}{
    \includegraphics[scale=3]{figure7.pdf}
    \parbox[b]{12.5cm} {
